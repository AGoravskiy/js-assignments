...
## Javascript Assignments  [![Build Status](https://travis-ci.org/AGoravskiy/js-assignments.svg?branch=master)](https://travis-ci.org/AGoravskiy/js-assignments)
...
* Run `git clone https://github.com/AGoravskiy/js-assignments.git` from command line to download the repo.
